(function() {
  ...
  module.exports = Shopify = (function() {
    ...
    Shopify.prototype.extend = function() {
      ...
      _(["ProductImage", "ProductVariant", "BlogArticle"]).chain().map(utils.nest).forEach(this.nested_methodize);
      _({
        count: "get,count",
        authors: "get,authors",
        tags: "get,tags",
        ...
        return (function(type, method) {
          ...
          if (!Shopify.prototype[method]) {
            return Shopify.prototype[method] = function(arg) {
              var callback, deferred, opts, req;
              if (_.isObject(arg)) {
      ...
      _(['id', 'body', 'route', 'child', 'qs']).forEach(function(setter) {
